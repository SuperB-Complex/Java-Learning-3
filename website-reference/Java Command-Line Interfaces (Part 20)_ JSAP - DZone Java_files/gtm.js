...
"resource": {
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",0],
      "arg1":"\/refcardz\/oauth-patterns-and-anti-patterns"
    },{
      "function":"_re",
      "arg0":["macro",15],
      "arg1":"(^$|((^|,)6133197_518($|,)))"
      ...
      "function":"_cn",
      "arg0":["macro",19],
      "arg1":"\/microservices-and-workflow-engines"
    },{
      "function":"_cn",
      "arg0":["macro",19],
...
var Kd=[C.B,C.J],Ld=function(a){var b=a[C.ae];b&&F(40);var c=a[C.be];c&&F(41);for(var d=Ha(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.ae&&f!==C.be)if(-1<Ia(Kd,f)){var h=f,k=a[f],l=d[e];vd().set(h,k,l,"US","US-IL",c)}else{}},Md=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
Z.g.gaawe=["google"],function(){function a(d,e,f){for(var h=0;h<e.length;h++)d.hasOwnProperty(e[h])&&(d[e[h]]=f(d[e[h]]))}function b(d,e,f){var h={id:"transaction_id",revenue:"value",list:"item_list_name"},k={click:C.Rc,detail:C.xa,add:C.Wa,remove:C.Xa,checkout:C.Ka,checkout_option:"checkout_option",purchase:C.la,refund:C.Ya},l={},p=function(t,r){l[t]=l[t]||r},q=function(t,r,v){v=void 0===v?!1:v;c.push(6);if(t){l.items=l.items||[];for(var w={},y=0;y<t.length;w={Ta:w.Ta},y++)w.Ta={},Oa(t[y],function(A){return function(z,
B){v&&"id"===z?A.Ta.promotion_id=B:v&&"name"===z?A.Ta.promotion_name=B:A.Ta[z]=B}}(w)),l.items.push(w.Ta)}if(r)for(var x in r)h.hasOwnProperty(x)?p(h[x],r[x]):p(x,r[x])},n;"dataLayer"===d.vtp_getEcommerceDataFrom?(n=gf(d.vtp_gtmEventId,"eventModel"))||(n=gf(d.vtp_gtmEventId,"ecommerce")):n=d.vtp_ecommerceMacroData;if(ob(n)){c.push(5);for(var u in n)n.hasOwnProperty(u)&&("currencyCode"===u?p("currency",n.currencyCode):"impressions"===u&&e===C.Xb?q(n.impressions,null):"promoClick"===u&&e===C.je?q(n.promoClick.promotions,
n.promoClick.actionField,!0):"promoView"===u&&e===C.ke?q(n.promoView.promotions,n.promoView.actionField,!0):k.hasOwnProperty(u)?e===k[u]&&q(n[u].products,n[u].actionField):l[u]=n[u]);m(l,f)}}var c=[];(function(d){Z.__gaawe=d;Z.__gaawe.h="gaawe";Z.__gaawe.i=!0;Z.__gaawe.priorityOverride=0})(function(d){var e=String(d.vtp_measurementIdOverride||d.vtp_measurementId),f=String(d.vtp_eventName);if("_"===f.charAt(0))J(d.vtp_gtmOnFailure);else{var h={};c=[];d.vtp_sendEcommerceData&&(0<=C.Oe.indexOf(f)||"checkout_option"===
f)&&b(d,f,h);var k=Mn(d.vtp_eventParameters,"name","value"),l;for(l in k)k.hasOwnProperty(l)&&(h[l]=k[l]);if(h.hasOwnProperty(C.na)||d.vtp_userProperties){var p=h[C.na]||{};m(Mn(d.vtp_userProperties,"name","value"),p);h[C.na]=p}lq(h);0<c.length&&(h[C.hd]=c);a(h,C.Ne,function(q){return Wa(q)});a(h,C.Pe,function(q){return Number(q)});ll(f,h,e);J(d.vtp_gtmOnSuccess)}})}();
...
Z.g.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=ul(c,"gtm.click");Xm(d)}}(function(b){Z.__cl=b;Z.__cl.h="cl";Z.__cl.i=!0;Z.__cl.priorityOverride=0})(function(b){if(!bn("cl")){var c=U("document");kd(c,"click",a,!0);cn("cl")}J(b.vtp_gtmOnSuccess)})}();Z.g.k=["google"],function(){(function(a){Z.__k=a;Z.__k.h="k";Z.__k.i=!0;Z.__k.priorityOverride=0})(function(a){return Zm(a.vtp_name,Wm("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Z.g.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Tm()}function b(f,h){kd(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:Vm(l),S:Um(l)})})}function c(f,h){kd(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:Vm(l),S:Um(l)})})}function d(f,h,k){var l=h.history,p=l[f];if(Da(p))try{l[f]=function(q,n,u){p.apply(l,[].slice.call(arguments,0));k({source:f,state:q,url:Vm(Tm()),
S:Um(Tm())})}}catch(q){}}function e(){var f={source:null,state:U("history").state||null,url:Vm(Tm()),S:Um(Tm())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.S!=h.S){var p={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.S,"gtm.newUrlFragment":h.S,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;Xm(p)}}}(function(f){Z.__hl=f;Z.__hl.h="hl";Z.__hl.i=!0;Z.__hl.priorityOverride=
0})(function(f){var h=U("self");if(!bn("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);cn("hl")}J(f.vtp_gtmOnSuccess)})}();
