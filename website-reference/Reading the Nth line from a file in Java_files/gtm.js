...
Z.g.j=["google"],function(){(function(a){Z.__j=a;Z.__j.h="j";Z.__j.i=!0;Z.__j.priorityOverride=0})(function(a){for(var b=String(a.vtp_name).split("."),c=V(b.shift()),d=0;d<b.length;d++)c=c&&c[b[d]];en(c,"j",a.vtp_gtmEventId);return c})}();
...
n.vtp_trackType){E("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var wa=function(da){return Vm("transaction"+da,1)},ma=wa("Id");E("ecommerce:addTransaction",{id:ma,affiliation:wa("Affiliation"),revenue:wa("Total"),shipping:wa("Shipping"),tax:wa("Tax")});for(var Y=wa("Products")||[],Ca=0;Ca<Y.length;Ca++){var kb=Y[Ca];E("ecommerce:addItem",{id:ma,sku:kb.sku,name:kb.name,category:kb.category,price:kb.price,
quantity:kb.quantity})}E("ecommerce:send");}else if("TRACK_TIMING"==n.vtp_trackType){}else if("DECORATE_LINK"==
...
0})(function(h){function k(y,B,D){return"DATA_LAYER"===y?Vm(D):h[B]}function l(){v("gdpr_consent",Wj());}function p(){var y=[];return y}function q(y){var B=!0,D=[];if(y){D=p();}B&&b.push(u)}function n(){}Zh();var u={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:h.vtp_conversionId,google_conversion_label:h.vtp_conversionLabel,google_conversion_value:h.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:h.vtp_gtmOnSuccess,gtm_onFailure:h.vtp_gtmOnFailure,google_gtm:sj()};u.google_gtm_experiments={capi:!0};
h.vtp_rdp&&(u.google_restricted_data_processing=!0);void 0!=Vm(C.M)&&!1!==Vm(C.M)&&(u.google_gtm_url_processor=function(y){return y=uh(y)});var r=function(y){return function(B,D,E){var I=k(y,D,E);I&&(u[B]=I)}},t=r("JSON");t("google_conversion_currency","vtp_currencyCode");t("google_conversion_order_id","vtp_orderId");h.vtp_enableProductReporting&&(t=r(h.vtp_productReportingDataSource),t("google_conversion_merchant_id","vtp_awMerchantId","aw_merchant_id"),t("google_basket_feed_country","vtp_awFeedCountry",
...
"ea");f("vtp_eventLabel","el");f("vtp_eventValue","ev");d.push(e);b.vtp_gtmOnSuccess()}else if(a)b.vtp_gtmOnSuccess();else try{P("//bat.bing.com/bat.js",function(){var h=Jc(V("UET"),{ti:b.vtp_tagId,q:d});G[c]=h;h.push("pageLoad");b.vtp_gtmOnSuccess()},b.vtp_gtmOnFailure),a=!0}catch(h){J(b.vtp_gtmOnFailure)}})}();Z.g.smm=["google"],function(){(function(a){Z.__smm=a;Z.__smm.h="smm";Z.__smm.i=!0;Z.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=Ln(a.vtp_map,"key","value")||{},d=c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue;en(d,"smm",a.vtp_gtmEventId);return d})}();
