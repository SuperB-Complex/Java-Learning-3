...
function Product(id, feed_id, is_ena) {
  ...
  this.product_text_container = this.product_details_container.querySelector('.product_text_container');
...
Product.prototype.init = function() {
  ...
  tl.set(this.dell_logo_product[templateType], {className: "-=gwd-page-content-display-none", autoAlpha: 0, visibility: 'hidden'});
};
...
Product.prototype.slideInFromRight = function() {
  ...
  tl.fromTo(this.product_image[this.imageType], 0.5, {autoAlpha: 0, visibility: 'hidden'}, {autoAlpha: 1, visibility: 'visible'}, "slide_in_from_right");
...
Product.prototype.slideOutToLeft = function() {
  ...
  tl.to(this.product_image[this.imageType], 0.5, {autoAlpha: 0, visibility: 'hidden', left: "-="+BANNER_WIDTH/2.5}, "slide_out_to_left");
  tl.to(this.product_image[this.imageType], 0, {left: "+="+BANNER_WIDTH/2.5}, "slide_out_to_left+=0.5");
...
Product.prototype.slideInFromLeft = function() {
  ...
  tl.fromTo(this.product_image[this.imageType], 0.5, {autoAlpha: 0, visibility: 'hidden', left: "-="+BANNER_WIDTH/2.5}, {autoAlpha: 1, visibility: 'visible', left: "+="+BANNER_WIDTH/2.5}, "slide_in_from_left");
...
Product.prototype.slideOutToRight = function() {
  ...
  tl.to(this.product_image[this.imageType], 0.5, {autoAlpha: 0, visibility: 'hidden'}, "slide_out_to_right");
...
function Banner() {
  ...
  this.headline_offer = document.getElementById('logo_banner_headline_container');
  ...
  this.mdf_text = this.mdf_text_container.querySelector('.mdf_text');
...
Banner.prototype.init = function() {
  ...
  this.tl.set(this.intro_headline_container, {autoAlpha:0, visibility: 'hidden', top: '-='+(BANNER_HEIGHT)});
  this.tl.set(this.product_image_square_intro, {autoAlpha:0, visibility: 'hidden', top: '+='+(BANNER_HEIGHT)});
...
Banner.prototype.animate = function() {
  this.tl = new TimelineLite();
  this.tl.to(this.intro_headline_container, 0.5, {autoAlpha:1, visibility: 'visible', top: '+='+(BANNER_HEIGHT)}, "intro_frame");
  this.tl.to(this.product_image_square_intro, 0.5, {autoAlpha:1, visibility: 'visible', top: '-='+(BANNER_HEIGHT)}, "intro_frame");
  this.tl.to(this.intro_headline_container, 0.5, {autoAlpha:0, visibility: 'hidden', top: '-='+(BANNER_HEIGHT)}, "intro_frame+=2.5");
  this.tl.to(this.product_image_square_intro, 0.5, {autoAlpha:0, visibility: 'hidden', top: '-='+(BANNER_HEIGHT)}, "intro_frame+=2.5");
...
Banner.prototype.showOffer = function() {
  ...
  tl.fromTo(this.headline_offer, 0.5, {autoAlpha: 0, visibility: 'hidden', top: "-="+BANNER_HEIGHT}, {autoAlpha: 1, visibility: 'visible', top: "+="+BANNER_HEIGHT}, "show_offer");
  // tl.fromTo(this.circle_and_lines_container, 0.5, {autoAlpha: 0, visibility: 'hidden', top: "+="+BANNER_HEIGHT}, {autoAlpha: 1, visibility: 'visible', top: "-="+BANNER_HEIGHT}, "show_offer");
};
...
function main(feedsIn) {
  ...
  setTimeout(function() {
    ...
    var customVariableHelper = new CustomVariableHelper({
	    ...
	    'customVariable8': 'currency+price_now',
      ...
      'customVariable11': 'url',
	    ...
	    'customVariable16': 'ena_currencypricetext',
